...
import 'package:ultima/flutter_google_places_autocomplete.dart';
...
class GooglePlaces {
  ...
  GoogleMapsPlaces _places =
      new GoogleMapsPlaces(apiKey: 'AIzaSyAkA-O8S7tInbJ099PpGzNqR3g5e_CkvBY');
  Location location;
  ...
  Future findPlace(BuildContext context) async {
    Prediction p = await showGooglePlacesAutocomplete(
      context: context,
      location: location,
      apiKey: "AIzaSyAkA-O8S7tInbJ099PpGzNqR3g5e_CkvBY",
      onError: (res) {
